...
public final class TestDataProvider {
    ...
    public static ApiLatestRatesResponse usdSnapshot() {
        return new ApiLatestRatesResponse(
                true, USD, SNAPSHOT_DATE,
    ...
    public static MultiConversionResponse multiConversionResponse() {
        return new MultiConversionResponse(USD, AMOUNT_100, List.of(
                new ConversionResult(EUR, EUR_CONVERTED_100, EUR_RATE),
